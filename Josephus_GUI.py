...
This Graphical User Interface (GUI) application solves the Josephus
Problem. A well known mathematical problem where the goal is to work out 
in which position to stand in a group of people to be the last one alive.

The user is asked how many people there are, and by pressing <return> or
using the 'Solve' button can see in which position Josephus should stand.
