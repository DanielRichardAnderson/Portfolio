"""
This simple web-scraping application will get the titles, links,
star-ratings and descriptions of the first 20 books on the
books.toscrape.com website.

Then, the application places this information into a .csv file, ready
for data-analysis and saves it to the desktop.
...
########################
csv_file_path = f'/Users/{username}/Desktop/scraped_file.csv'
